...
function useNavbarActiveState() {
  ...
  return useMemo(
    () => ({
      ...
      queue: includes(["Queue"], currentRoute.id),
    }),
    [currentRoute.id]
  );
}
    ...
    <nav className="desktop-navbar">
      ...
      <NavbarSection>
        ...
        {currentUser.hasPermission("list_alerts") && (
          ...
          <Menu.Item key="queue" className={activeState.queue ? "navbar-active-item" : null}>
            <Link href="queue">
              <HistoryOutlinedIcon aria-label="Data Queue button" />
              <span className="desktop-navbar-label">Queue</span>
            </Link>
          </Menu.Item>
      </NavbarSection>
